    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.UUIDField(default=uuid.uuid4, error_messages={'unique': 'A user with that username already exists.'}, unique=True)),
            ...
            managers=[
                ('objects', project.user.manager.UserManager()),
            ],
        ),
    ]
